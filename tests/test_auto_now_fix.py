#!/usr/bin/env python3
"""
Test script to verify the auto_now field fix in django-bulk-hooks.
This demonstrates how auto_now fields are preserved during upsert operations.
"""
...
def test_auto_now_preservation():
    """Test that auto_now fields are preserved during upsert operations"""
    print("Testing auto_now field preservation during upsert operations...")
    ...
    print(f"Upsert operation completed. Result: {result}")
...
if __name__ == "__main__":
    try:
        success = test_auto_now_preservation()
        if success:
            print("\n🎉 All tests passed!")
        else:
            print("\n💥 Some tests failed!")
