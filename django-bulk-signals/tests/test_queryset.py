...
from django_bulk_signals.signals import (
    bulk_pre_create, bulk_post_create,
    bulk_pre_update, bulk_post_update,
    bulk_pre_delete, bulk_post_delete
)
...
class TestBulkSignalQuerySet(TestCase):
    ...
    def test_bulk_update_with_missing_original_warning(self):
        ...
        with patch.object(self.model.objects, 'filter') as mock_filter, \
             ...
             patch.object(qs.__class__.__bases__[0], 'bulk_update') as mock_super_bulk_update:
